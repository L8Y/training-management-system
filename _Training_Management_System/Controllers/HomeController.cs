...
namespace _Training_Management_System.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult login(string email, string password, string role)
        {
            ...
            bool isValidUser = ob.login(email, password, role);
            ...
            //}
            //HttpContext.Session.SetString("a", "A1123");
            //return View("login");re
        }
        ...
        public ViewResult applyCourses(int id , string startDate, string endDate)
        {
